...
class Z extends InstancedMesh {
    config: typeof DefaultBallpitConfig;
    physics: W;
    ambientLight: AmbientLight | undefined;
    light: PointLight | undefined;

    constructor(renderer: WebGLRenderer, params: Partial<typeof DefaultBallpitConfig> = {}) {
...
const Ballpit: React.FC<BallpitProps> = ({
    ...
    // ── Live physics updates (no remount needed) ──────────────────
    useEffect(() => {
